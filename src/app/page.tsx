        ...
        <div className="h-full md:pb-10 flex flex-col lg:flex-row px-6 sm:px-8 md:px-12 lg:px-20 xl:px-40">
          ...
          <div className="h-1/2 lg:h-full lg:w-1/2 flex flex-col gap-8 items-center justify-center">
            ...
            <p className="md:text-xl text-purple-500">
              &lsquo;👋 Hi! I&apos;m Subhajit Pramanik, a skilled web developer
              passionate about creating dynamic and user-friendly websites.
              Proficient in JavaScript, TypeScript, Node JS, Express JS,
              ReactJS, NextJS, Tailwind CSS, MySQL, I specialize in crafting
              engaging online experiences that exceed expectations. Let&apos;s
              collaborate and bring your digital vision to life!&rsquo;
            </p>
            <div className="w-full flex gap-4">
              ...
              <Link href="/resume-subho1011.pdf" target="_blank">
                <button className="p-4 rounded-lg ring-2 ring-purple-950 text-purple-700 font-semibold">
                  Resume
                </button>
              </Link>
            </div>
